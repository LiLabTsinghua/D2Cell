...
if __name__ == '__main__':
    venn3_plot(csv_file='../../Result/D2Cell-pred Result/Ecoli/ecoli_test_unseen_product.csv')
    venn3_plot(csv_file='../../Result/D2Cell-pred Result/Ecoli/ecoli_laser_predict.csv', output='../../Result/fig4_d2.pdf')