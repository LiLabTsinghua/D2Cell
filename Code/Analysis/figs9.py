...
if __name__ == '__main__':
    xlabel = ['Test data', 'Unseen product set', 'Mutiple gene test set']
    ...
    bar(ylabel='Accuracy on test dataset (%)', label_list=xlabel, value_list=d2cell_result, value_list2=no_gem_result,
        rotation=45, output='../../Result/figs9_a.pdf', strain='E. coli')
    ...
    print(no_gem_result)
    bar(ylabel='Accuracy on test dataset (%)', label_list=xlabel, value_list=d2cell_result, value_list2=no_gem_result,
        rotation=45, output='../../Result/figs9_b.pdf', strain='S. cerevisiae')
    ...
    print(no_gem_result)
    bar(ylabel='Accuracy on test dataset (%)', label_list=xlabel, value_list=d2cell_result, value_list2=no_gem_result,
        rotation=45, output='../../Result/figs9_c.pdf', strain='C. glutamicum')
