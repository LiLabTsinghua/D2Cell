...
def accuracy_unseen_product():
    df_cg_test = pd.read_csv('../../Result/D2Cell-pred Result/Cg/cg_test_multiple_gene.csv')
    df_ecoli_test = pd.read_csv('../../Result/D2Cell-pred Result/Ecoli/ecoli_test_multiple_gene.csv')
    df_yeast_test = pd.read_csv('../../Result/D2Cell-pred Result/Yeast/yeast_test_multiple_gene.csv')
...
if __name__ == '__main__':
    ...
    bar(ylabel='Accuracy on multiple gene\nmodification (%)', label_list=xlabel, value_list=value_list,
        rotation=0, output='../../Result/fig4_e.pdf')